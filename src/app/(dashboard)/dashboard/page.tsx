  ...
  return (
    <div className="p-4 md:p-10 max-w-[1400px] mx-auto">
      ...
      <div className="grid grid-cols-2 gap-3 mb-4 md:mb-8 md:flex md:flex-wrap">
        ...
        <Link href="/agenda">
          <button className="w-full md:w-auto border border-border bg-card text-[#C084FC] px-5 py-2.5 rounded-lg font-bold text-sm hover:border-primary transition-all flex items-center justify-center gap-2">
            <CalendarPlus className="w-4 h-4" /> Nueva cita
          </button>
        </Link>
        <Link href="/campanas">
          <button className="w-full md:w-auto border border-border bg-card text-foreground px-5 py-2.5 rounded-lg font-bold text-sm hover:bg-secondary transition-all flex items-center justify-center gap-2">
